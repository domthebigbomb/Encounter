...
- (void)getDirectionsFrom:(NSString*)origin to:(NSString*)destination withTransitType:(NSString *)transitType succeeded:(void(^)(GMDirection *directionResponse))success failed: (void (^)(NSError *error))failure;
